...
public class AssetManager : MonoBehaviour
{
    ...
    {
        weapons.Add(new TestWeapon("Weapon 1", "Does things", 0, 0, 1.5f, 5, 5, 1, 2, 1, new Vector3(0, 3, 4), new Vector3(2, 0.5f, 1), weaponImages[0], chosenWeaponImages[0], weaponModels[0]));
